...
// import { Megaphone, Users, BellRing, ShieldCheck } from "lucide-react";
...
//       <header className="bg-gradient-to-r from-blue-900 to-black py-16 text-center text-white">
...
//         <h2 className="text-3xl font-semibold text-center mb-10 text-blue-900">Why Use This Platform?</h2>
//         <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
//           {features.map((feature, index) => (
//             <div
//               key={index}
//               className="flex items-start gap-4 p-6 bg-white rounded-2xl shadow-md border border-gray-200"
//             >
    ...
    <div className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-white">
      <header className="relative bg-gradient-to-r from-blue-900 to-black py-16 text-center text-white">
        <div className="absolute top-4 right-6 flex gap-4">
          ...
          <button className="bg-white text-blue-900 px-4 py-2 rounded-full font-medium hover:bg-gray-100 transition text-sm">
            Login
          </button>
